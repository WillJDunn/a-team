...
DELETE FROM users;
INSERT INTO users (user_id, user_name, password, email, registered_at) VALUES (1, 'Will', 'foo', 'dunnw@bu.edu', NOW());
INSERT INTO users (user_id, user_name, password, email, registered_at) VALUES (2, 'Anirudh', 'foo', 'akart@bu.edu', NOW());
INSERT INTO users (user_id, user_name, password, email, registered_at) VALUES (3, 'Annie', 'foo', 'yinchia@bu.edu', NOW());
INSERT INTO users (user_id, user_name, password, email, registered_at) VALUES (4, 'Dhiren', 'foo', 'dhirenv@bu.edu', NOW());
INSERT INTO users (user_id, user_name, password, email, registered_at) VALUES (5, 'Jianqing', 'foo', 'gaojq@bu.edu', NOW());
INSERT INTO users (user_id, user_name, password, email, registered_at) VALUES (6, 'Jimmy', 'foo', 'jgoddard@bu.edu', NOW());
INSERT INTO users (user_id, user_name, password, email, registered_at) VALUES (7, 'Behdad', 'foo', 'foo@bar.edu', NOW());
INSERT INTO users (user_id, user_name, password, email, registered_at) VALUES (8, 'testuser', 'foo', 'foo@foo.com', NOW());
